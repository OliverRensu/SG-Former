...
parser = argparse.ArgumentParser(description='SGFormer Training and Evaluating')

# Dataset / Model parameters
parser.add_argument('--data', default='/mnt/blob/testset/ImageNet', metavar='DIR',
                    help='path to dataset')
parser.add_argument('--model', default='sgformer_b', type=str, metavar='MODEL',
...
def main():
    ...
    model = sgformer.__dict__[args.model](drop_path_rate=args.drop_path)
